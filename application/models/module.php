...
class Module extends Eloquent{
	...
	public static function create_module($client_data){
		...
		$module_array['display_name'] = $client_data->displayName;
	...
	public static function get_modules($client_data = null){
			...
			$result = $query_result->get(
					...
					array('id','name','display_name','role_id','roles.name as role_name','privileges')
				);
